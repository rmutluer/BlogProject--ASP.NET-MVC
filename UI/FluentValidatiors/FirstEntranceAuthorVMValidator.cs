...
{
    public class FirstEntranceAuthorVMValidator:AbstractValidator<FirstEntranceAuthorViewModel>
    {
        public FirstEntranceAuthorVMValidator()
        {
            ...
            RuleFor(x => x.Country)
             ...
             .WithName("Uyruk")
             .WithMessage("{PropertyName} alanı boş bırakılamaz.")
             .Matches(new Regex(@"^\s*[a-zA-ZıüöçşğİÜÖÇŞĞ]+$"))
             .WithMessage("lütfen Sadece harf girişi yapınız");
        }
    }
}
